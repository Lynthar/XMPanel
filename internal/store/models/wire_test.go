...
func TestWireTypesMatchFrontend(t *testing.T) {
	...
	sameSet(t, "adapter.MatrixAccountFacts json", jsonFields(adapter.MatrixAccountFacts{}), "lib/api.ts MatrixAccountFacts", tsFields(t, "MatrixAccountFacts"))
	...
	sameSet(t, "adapter.MatrixRoomFacts json", jsonFields(adapter.MatrixRoomFacts{}), "lib/api.ts MatrixRoomFacts", tsFields(t, "MatrixRoomFacts"))
